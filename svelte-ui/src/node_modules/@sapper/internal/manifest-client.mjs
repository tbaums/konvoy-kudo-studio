...
export const components = [
	...
	{
		js: () => import("../../../routes/user-research.svelte"),
...
if (typeof window !== 'undefined') {
	import("/Users/michael/kudo-konvoy-studio/svelte-ui/node_modules/sapper/sapper-dev-client.js").then(client => {
