...
const css = {
	...
	map: "{\"version\":3,\"file\":\"ResearchInput.svelte\",\"sources\":[\"ResearchInput.svelte\"],\"sourcesContent\":[\"<style>\\n    div {\\n        width: 100%;\\n        height: 100%;\\n    }\\n    \\n    img {\\n        width: 100%;\\n    }\\n    \\n    h2 {\\n        text-align: center;\\n    }\\n</style>\\n\\n<script>\\n    let m = {\\n        x: 0,\\n        y: 0\\n    };\\n    let src = 'homepage.png'\\n\\n    function handleMousemove(event) {\\n        m.x = event.clientX;\\n        m.y = event.clientY;\\n        post_cursor_coordinates()\\n    }\\n\\n    async function post_cursor_coordinates() {\\n        let xhr = new XMLHttpRequest()\\n        let url = 'https://' + current_host + '/kafka-client-api/write?topic=research&payload={\\\"x\\\":\\\"' +\\n            m.x +\\n            '\\\",\\\"y\\\":\\\"' +\\n            m.y +\\n            '\\\"}'\\n        console.log(\\\"url is: \\\", url)\\n        xhr.open(\\\"GET\\\", url)\\n    }\\n</script>\\n\\n\\n<div on:mousemove={handleMousemove}>\\n    <h2>Move mouse around page</h2>\\n    <img {src} alt=\\\"Mesosphere homepage\\\"> The mouse position is {m.x} x {m.y}\\n</div>\"],\"names\":[],\"mappings\":\"AACI,GAAG,cAAC,CAAC,AACD,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,GAAG,cAAC,CAAC,AACD,KAAK,CAAE,IAAI,AACf,CAAC,AAED,EAAE,cAAC,CAAC,AACA,UAAU,CAAE,MAAM,AACtB,CAAC\"}"
};
