...
const css = {
	code: "div.svelte-1etw4g3{width:100%;height:100%}img.svelte-1etw4g3{width:100%}",
	map: "{\"version\":3,\"file\":\"ResearchInput.svelte\",\"sources\":[\"ResearchInput.svelte\"],\"sourcesContent\":[\"<script>\\n    let m = {\\n        x: 0,\\n        y: 0\\n    };\\n\\n    function handleMousemove(event) {\\n        m.x = event.clientX;\\n        m.y = event.clientY;\\n    }\\n\\n    let src = 'homepage.png'\\n</script>\\n\\n<style>\\n    div {\\n        width: 100%;\\n        height: 100%;\\n    }\\n    \\n    img {\\n        width: 100%;\\n    }\\n</style>\\n\\n<div on:mousemove={handleMousemove}>\\n    <img {src} alt=\\\"Mesosphere homepage\\\"> The mouse position is {m.x} x {m.y}\\n</div>\"],\"names\":[],\"mappings\":\"AAeI,GAAG,eAAC,CAAC,AACD,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,GAAG,eAAC,CAAC,AACD,KAAK,CAAE,IAAI,AACf,CAAC\"}"
};
...
const ResearchInput = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="svelte-1etw4g3">
	    <img${(v => v == null ? "" : ` src="${__chunk_1.escape(src)}"`)(src)} alt="Mesosphere homepage" class="svelte-1etw4g3"> The mouse position is ${__chunk_1.escape(m.x)} x ${__chunk_1.escape(m.y)}
	</div>`;
});
...
const css$1 = {
	code: "div.svelte-1etw4g3{width:100%;height:100%}img.svelte-1etw4g3{width:100%}",
	map: "{\"version\":3,\"file\":\"ResearchOutput.svelte\",\"sources\":[\"ResearchOutput.svelte\"],\"sourcesContent\":[\"<script>\\n    let src = 'homepage.png'\\n</script>\\n\\n<style>\\n    div {\\n        width: 100%;\\n        height: 100%;\\n    }\\n    \\n    img {\\n        width: 100%;\\n    }\\n</style>\\n\\n<div on:mousemove={handleMousemove}>\\n    <img {src} alt=\\\"Mesosphere homepage\\\">\\n</div>\"],\"names\":[],\"mappings\":\"AAKI,GAAG,eAAC,CAAC,AACD,KAAK,CAAE,IAAI,CACX,MAAM,CAAE,IAAI,AAChB,CAAC,AAED,GAAG,eAAC,CAAC,AACD,KAAK,CAAE,IAAI,AACf,CAAC\"}"
};
...
const ResearchOutput = __chunk_1.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="svelte-1etw4g3">
	    <img${(v => v == null ? "" : ` src="${__chunk_1.escape(src$1)}"`)(src$1)} alt="Mesosphere homepage" class="svelte-1etw4g3">
	</div>`;
});
